...
```
The mean of the total number of steps taken per day is `r as.integer(mymean)`.  
The median of the total number of steps taken per day is `r mymedian`.
...
```
The 5-minute interval containing maximum number of steps starts from `r maxint` minute.
...
```
The total number of missing values NA in the dataset is `r totalNA`.  
The missing data were filled by daily mean.  
The mean of the total number of steps taken per day is `r as.integer(mymean2)`.    
The median of the total number of steps taken per day is `r as.integer(mymedian2)`.  
